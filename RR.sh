...
while true; do
    echo -e "\n\$----====Enter====----$"
    echo -e "\" 1 + Enter \" to start the service or reselect model,"
    echo -e "\" 2 + Enter \" to stop the service, or"
    echo -e "\" 3 + Enter \" to exit the script (the service will continue running in the background):"
    ...
    case $command in
        ...
        3)
            ...
            ;;
        *)
            echo -e "\n====Invalid command. RWKV-Runner started.===="
            echo -e "\nhttp://192.168.1.15:8000 for LAN."
            echo -e "\nhttp://cgxcgx.com:54321 for WAN."
    esac
done
